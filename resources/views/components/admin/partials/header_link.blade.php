...
<link href="{{ asset('plugins/cropper/croppie.css') }}" rel="stylesheet" type="text/css" />  

<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css"/>

<link href="{{ asset('plugins/select2/css/select2.min.css') }}" rel="stylesheet" type="text/css" />

<link href="{{ asset('plugins/tui-calendar/tui-calendar.min.css') }}" rel="stylesheet" type="text/css" />
...
<!-- Optional Themes -->
<link rel="stylesheet" href="{{ asset('css/evo-calendar.midnight-blue.css') }}" />
<link rel="stylesheet" href="{{ asset('css/evo-calendar.orange-coral.css') }}" />
<link rel="stylesheet" href="{{ asset('css/evo-calendar.royal-navy.css') }}" />
