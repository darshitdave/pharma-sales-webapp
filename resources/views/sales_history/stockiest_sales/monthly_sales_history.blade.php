                                ...
                                @foreach($get_stockiest_data as $gk => $gv)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" class="form-control number change_amount amount_{{$gv->id}}" name="brand_priority" autocomplete="off" data-id="{{$gv->id}}" @if($gv->amount != ''  || $gv->amount == 0) data-value="{{$gv->amount}}" value="{{$gv->amount}}" @endif>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary waves-effect waves-light statement save_and_next_button" href="{{ route('admin.medicalstoreHistoryReportList',[$gv->id,$gv->sales_id]) }}" title="Stockiest Wise Medical Store"  role="button"><i class="bx bx-trending-up"></i></a>

                                            <a class="btn btn-primary waves-effect waves-light statement save_and_next_button" href="javascript:void(0);" data-toggle="modal" data-target="#example_02" data-id="{{$gv->id}}" title="Stockiest Statement" role="button"><i class="bx bx-notepad"></i></a>
                                            
                                            <a class="btn btn-danger waves-effect waves-light cancel_button" href="{{ route('admin.deleteStockiestData',[$gv->id,$gv->sales_id]) }}" role="button" title="Remove Stockiest Record" onclick="return confirm('Do you want to clear this data?');"><i class="bx bx-trash-alt"></i></a>
