            ...
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">
                        @if(isset($get_stockiest_detail['mr_detail']['full_name'])) {{$get_stockiest_detail['mr_detail']['full_name']}} : @endif 
                                ...
                                @foreach($get_medical_store_data as $gk => $gv)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" class="form-control number change_amount amount_{{$gv->id}}" name="brand_priority" autocomplete="off" data-id="{{$gv->id}}" @if($gv->sales_amount != '' || $gv->sales_amount == 0) data-value="{{$gv->sales_amount}}" value="{{$gv->sales_amount}}" @endif>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger waves-effect waves-light remove" href="{{ route('admin.deleteDoctorData',[$gv->id,$gv->medical_store_id,$gv->stockiest_id,$gv->sales_id]) }}" role="button" onclick="return confirm('Do you want to clear this data?');" title="Remove Doctor Record"><i class="bx bx-trash-alt"></i></a>
