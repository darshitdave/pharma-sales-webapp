                ...
                <div class="card">
                    <div class="card-body">
			                    	...
			                    	<div class="mb-3 row align-items-center">
                                        ...
                                        <div class="col-md-2">
                                            <div class="mt-2 mt-md-0">
                                                <a class="btn btn-danger waves-effect waves-light remove_file" href="javascript:void(0);" role="button" onclick="return confirm('Do you want to remove this attachment?');"><i class="bx bx-trash-alt"></i></a>
                                            </div>
                                        </div>
			                    	</div>
			                    </div>
                        ...
                        <br><br><hr>
                            ...
                            <hr>
                            <h5 class="float-right">Download All <a href="{{route('admin.downloadStatementZip',$get_statement->id)}}" class="btn btn-primary waves-effect waves-light " role="button"><i class="bx bx-download"></i></a></h5>
		                                ...
		                                @foreach($get_attachment as $ak => $av)
		                                    <tr class="statement remove_statement_{{$av->id}}">
		                                        ...
		                                        <td>
													...
													<a href="{{ asset('uploads/statement') }}/{{$av->statement}}" class="btn btn-primary waves-effect waves-light" download="download" role="button"><i class="bx bx-download"></i></a>		                                        	

													<a href="{{ asset('uploads/statement') }}/{{$av->statement}}" target="_blank" class="btn btn-primary waves-effect waves-light" role="button"><i class="bx bx-show-alt"></i></a>		                             

		                                            <a href="javascript:void(0);" class="btn btn-danger waves-effect waves-light remove_attachment" data-id="{{$av->id}}"  role="button" onclick="return confirm('Do you want to remove this statement?');"><i class="bx bx-trash-alt"></i></a>
